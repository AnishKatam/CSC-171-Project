...
public class Main extends Application {
    ...
    private void runGame(GraphicsContext gc, Canvas canvas) {
        ...
        for (int i = 0; i < rounds; i++) {
            ...
            //------------------------------
            drawCard(gc, 0, players[underTheGun].getHand()[0].convertValueToCardName(), players[underTheGun].getHand()[0].getUnicodeSuit(), players[underTheGun].getHand()[0].getSuitColor().equals("RED") ? Color.RED : Color.BLACK);
            drawCard(gc, 200, players[underTheGun].getHand()[1].convertValueToCardName(), players[underTheGun].getHand()[1].getUnicodeSuit(), players[underTheGun].getHand()[1].getSuitColor().equals("RED") ? Color.RED : Color.BLACK);
            //------------------------------
            ...
            for (int p = 0; p < numPlayers; p++) {
                ...
                if (currentPlayer.hasToCall()) {
                    ...
                    //-------------------------------
                    drawCard(gc, 0, currentPlayer.getHand()[0].convertValueToCardName(), currentPlayer.getHand()[0].getUnicodeSuit(), currentPlayer.getHand()[0].getSuitColor().equals("RED") ? Color.RED : Color.BLACK);
                    drawCard(gc, 200, currentPlayer.getHand()[1].convertValueToCardName(), currentPlayer.getHand()[1].getUnicodeSuit(), currentPlayer.getHand()[1].getSuitColor().equals("RED") ? Color.RED : Color.BLACK);
                    //-------------------------------
                    action = scan.nextLine();
                    //----------------------
                    gc.clearRect(0, 0, canvas.getWidth(), canvas.getHeight());
                    ...
                    System.out.println(currentPlayer.getName() + " is the small blind and has to call 5$ or raise.");
                    ...
                    System.out.println("\nIt's " + currentPlayer.getName() + "'s turn");
                    System.out.println("He doesn't need to call, so he is able to check, fold, raise or go all in.");
                    //-------------------------------
                    drawCard(gc, 0, currentPlayer.getHand()[0].convertValueToCardName(), currentPlayer.getHand()[0].getUnicodeSuit(), currentPlayer.getHand()[0].getSuitColor().equals("RED") ? Color.RED : Color.BLACK);
                    drawCard(gc, 200, currentPlayer.getHand()[1].convertValueToCardName(), currentPlayer.getHand()[1].getUnicodeSuit(), currentPlayer.getHand()[1].getSuitColor().equals("RED") ? Color.RED : Color.BLACK);
                    //-------------------------------
