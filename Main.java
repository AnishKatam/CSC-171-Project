...
public class Main extends Application {
    ...
    private void runGame(GraphicsContext gc, Canvas canvas) {
        ...
        for (int i = 0; i < rounds; i++) {
            ...
            //------------------------------
            drawCard(gc, 0, players[underTheGun].getHand()[0]);
            drawCard(gc, 200, players[underTheGun].getHand()[1]);
            //------------------------------
            ...
            for (int p = 0; p < numPlayers; p++) {
                ...
                if (currentPlayer.hasToCall()) {
                    ...
                    //-------------------------------
                    drawCard(gc, 0, currentPlayer.getHand()[0]);
                    drawCard(gc, 200, currentPlayer.getHand()[1]);
                    //-------------------------------
                    action = scan.nextLine();
                    //----------------------
                    gc.clearRect(0, 0, canvas.getWidth(), canvas.getHeight());
    ...
    private static void drawCard(GraphicsContext gc, double xOffset, Card card) {
        ...
        Color color = card.getSuitColor().equals("RED") ? Color.RED : Color.BLACK;
        gc.setFill(color);
        gc.setFont(Font.font("Roboto Slab", 30));
        gc.fillText(card.convertValueToCardName(), xOffset + 20, 80);
        gc.fillText(card.getUnicodeSuit(), xOffset + 20, 120);
        gc.fillText(card.getUnicodeSuit(), xOffset + 160, 280);
    }
    private static void drawBoardCards(GraphicsContext gc, Card[] cards) {
        for (int i = 0; i < cards.length; i++) {
            drawCard(gc, (i * 200), cards[i]);
        }
    }
